  ...
  return <><TopNav /><main>
    <div className="docs-shell">
      ...
      <div className="docs-content"><aside className="docs-aside">ON THIS PAGE<a href="#quickstart">Quickstart</a><a href="#lifecycle">Lifecycle</a><a href="#configuration">Configuration</a><a href="#api">API reference</a><a href="#deployment">Deployment</a></aside><div>
        ...
        <Section id="lifecycle" title="Request lifecycle"><p>Meter uses an authorize/capture model. It reserves an amount before forwarding a call, then captures actual usage after the provider responds. Concurrent calls count outstanding holds as well as settled spend. A reservation based on a learned output percentile is statistical; set a provider output cap when strict output bounds matter.</p><ol><li><b>Authenticate</b> the Meter key and resolve project/environment.</li><li><b>Attribute</b> the feature, actor, and trace headers.</li><li><b>Estimate</b> locally count supported text input and predict output cost. Structured chat counts are estimates; provider usage is authoritative.</li><li><b>Reserve</b> budget headroom and check the circuit breaker.</li><li><b>Forward</b> bytes to the provider, including streaming responses.</li><li><b>Capture</b> actual token usage, price it, and release unused reserve.</li></ol></Section>
